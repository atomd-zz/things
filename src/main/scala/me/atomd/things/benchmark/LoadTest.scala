...
//object ThingClient {
//
//  def originalClusterClient(system: ActorSystem) = {
//    import scala.collection.JavaConversions._
//    val initialContacts = system.settings.config.getStringList("things.client.initial-contacts-points").toSet
//    system.actorOf(ClusterClient.props(initialContacts map system.actorSelection))
//  }
//
//  def apply(system: ActorSystem): ActorRef = {
//    val path = Thing.shardRegionPath(system)
//    system.actorOf(Props(classOf[ThingClient], path, originalClusterClient(system)))
//  }
//}
//
//class ThingClient(servicePath: String, originalClient: ActorRef) extends Actor with ActorLogging {
//  def receive = {
...
//
//      val driver = system.actorOf(Props(new LoadDriver), "benchmark-clients")
//
...
//}
//
//class LoadDriver extends Actor with ActorLogging {
//  import LoadDriver._
//
...
//      }
//  }
//  private def nMessagesExpected = nMessagesSent
//
